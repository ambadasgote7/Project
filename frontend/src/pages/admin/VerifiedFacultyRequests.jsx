      ...
      <main className="w-full flex-grow px-6 py-12">
        ...
        {loading && (
          <div className="w-full bg-white p-8 rounded-md shadow-sm border border-[#FFEDC7] text-center">
            <p className="text-[#EB4C4C] font-semibold text-lg animate-pulse">Loading verified faculty...</p>
          </div>
        )}
              ...
              <table className="min-w-full text-sm text-[#1A1A1A]">
                ...
                <tbody className="divide-y divide-gray-100">
                  {requests.map((req) => (
                    ...
                    >
                      <td className="px-6 py-5 align-middle font-bold text-[#1A1A1A] text-base">
                        {req.requesterName}
                      </td>
